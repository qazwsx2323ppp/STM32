...
int main(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12; //定义引脚
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB,&GPIO_InitStructure); //第一个参数值是选择外设，第二个参数是一个结构体地址
...
//	//Bit_SET == (BitAction)1 , Bit_RESET == (BitAction)0
   ...
   {
	   //蜂鸣器
       GPIO_WriteBit(GPIOB, GPIO_Pin_12, Bit_RESET);  //点亮LED
	   Delay_ms(100);
